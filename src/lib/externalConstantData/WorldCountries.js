...
const countries = [
  ...
  { country: 'Federated States of Micronesia', abbreviation: 'FM' },
  ...
  { country: 'United States Virgin Islands', abbreviation: 'VI' },
...
function getCountriesForSelectFieldOptions () {
  const countriesFormatted = {}
  const USA = countries.find(country => country.abbreviation === 'US') || {
...
export { countries, getCountriesForSelectFieldOptions }
